...
class RRT:
    ...
    def steer(self, from_node, to_node,
        ...
        d, theta = self.calc_distance_and_angle(new_node,
                   to_node)
        ...
        for _ in range(n_expand):
            new_node.x += self.path_resolution * \
                          math.cos(theta)
            new_node.y += self.path_resolution * \
                          math.sin(theta)
...
def main(gx=6.0, gy=10.0):
    ...
    obstacleList = [(14, 8, 2), (1, 10, 1), (3, 10, 1), (8, 10, 1), (3, 8, 1), (3, 6, 1), (5, 5, 1), (7, 5, 1), (9, 5, 1), (9, 3, 1),]
                   # [x, y, radius]
